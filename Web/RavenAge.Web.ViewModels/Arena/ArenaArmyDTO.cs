    ...
    public class ArenaArmyDTO : IMapFrom<City>, IHaveCustomMappings
    {
        ...
        public void CreateMappings(IProfileExpression configuration)
        {
            configuration.CreateMap<City, ArenaArmyDTO>()
                ...
                .ForMember(t => t.FullArcherDefence, opt => opt.MapFrom(s => s.ArchersArmy.Defence + s.ArchersArmy.DefenceBonus))
                .ForMember(t => t.FullArcherHealth, opt => opt.MapFrom(s => s.ArchersArmy.Health + s.ArchersArmy.HealthBonus))
                .ForMember(t => t.FullInfantriAttack, opt => opt.MapFrom(s => s.InfantryArmy.Attack + s.InfantryArmy.Bonus))
                .ForMember(t => t.FullInfantryDefence, opt => opt.MapFrom(s => s.InfantryArmy.Defence + s.InfantryArmy.DefenceBonus))
                .ForMember(t => t.FullInfantryHealth, opt => opt.MapFrom(s => s.InfantryArmy.Health + s.InfantryArmy.HealthBonus))
                .ForMember(t => t.FullCavaleryAttack, opt => opt.MapFrom(s => s.CavalryArmy.Attack + s.CavalryArmy.Bonus))
                .ForMember(t => t.FullCavaleryDefence, opt => opt.MapFrom(s => s.CavalryArmy.Defence + s.CavalryArmy.DefenceBonus))
                .ForMember(t => t.FullCavaleryHealth, opt => opt.MapFrom(s => s.CavalryArmy.Health + s.CavalryArmy.HealthBonus))
                .ForMember(t => t.FullArtileryAttack, opt => opt.MapFrom(s => s.ArtilleryArmy.Attack + s.ArtilleryArmy.Bonus))
                .ForMember(t => t.FullArtileryDefence, opt => opt.MapFrom(s => s.ArtilleryArmy.Defence + s.ArtilleryArmy.DefenceBonus))
                .ForMember(t => t.FullArtileryHealth, opt => opt.MapFrom(s => s.ArtilleryArmy.Health + s.ArtilleryArmy.HealthBonus))
