...
namespace RavenAge.Web.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string returnUrl = null, string type = null, string avatar = null, string rune = null)
        {
            if (type == null || avatar == null || rune == null)
            {
